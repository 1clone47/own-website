  ...
  <div class="bg-zinc-500 flex flex-col h-screen">
    ...
    >
      <div class="flex flex-col flex-1">
        <img
          src="../assets/images/no-background.png"
          class="h-80 w-1/2 flex-1"
          alt=""
        />
        <div class="flex flex-1 flex-row space-x-10 ml-20">
          <a href="mailto:andy.wagner1603@gmail.com" target="_blank">
            <svg
          ...
          <a href="https://github.com/1clone47" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
          ...
          <a
            href="https://www.discordapp.com/users/479518176661602315"
            target="_blank"
          >
            <svg
              width="24"
